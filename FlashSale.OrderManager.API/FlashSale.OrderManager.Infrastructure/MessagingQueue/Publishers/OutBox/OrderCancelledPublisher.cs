...
{
    public class OrderCancelledPublisher:BackgroundService
    {
        ...
        public OrderCancelledPublisher(
        ...
        private async Task ProcessBatch(CancellationToken stoppingToken)
        {
            ...
            while(!stoppingToken.IsCancellationRequested)
            {
                ...
                var outBoxMessageBatch = await _unitOfWork.Outbox.GetUnpublishedAsync(OutboxEventType.OrderCancelled);
